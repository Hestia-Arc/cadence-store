...
export const Hero = () => {
  return (
    <section className="h-fit sm:h-[760px] md:h-[760px] lg:h-[760px]  flex flex-col gap-[32px] bg-white px-8 pb-[40px] sm:px-40">
      ...
      {/* content */}
      <header className="min-h-[152px]  w-full flex flex-col justify-between items-center gap-4 sm:gap-0 sm:flex-row">
        <div className="h-[88px] sm:h-fit ">
          <h1 className="text-h4 text-[39px] sm:text-h2 font-poppins">
