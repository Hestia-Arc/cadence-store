  ...
  return (
    <div className="flex gap-6">
      <button
        ...
        onClick={onPrevious}
        className="flex items-center justify-center bg-gray-300 rounded-sm shadow px-4 text-[16px] font-semibold"
      >
        Prev
      </button>
      <div className="flex items-center gap-2">
        {paginationRange?.map((item: any, index: Key | null | undefined) => {
          if (item === DOTS) {
